...
use heelonvault_core::models::TeamMemberRole;
...
impl ManageTeamsDialog {
        ...
        TVault: VaultService + Send + Sync + 'static,
    {
        let window = gtk4::Window::builder()
            ...
            .title(heelonvault_core::tr!("manage-teams-window-title").as_str())
            .modal(true)
            .default_width(820)
            .default_height(620)
            .build();
        ...
        let header = gtk4::Box::builder()
            ...
            .spacing(8)
            .build();
        let title = gtk4::Label::new(Some(heelonvault_core::tr!("manage-teams-title").as_str()));
        title.add_css_class("title-3");
        title.set_hexpand(true);
        title.set_halign(gtk4::Align::Start);
        let create_btn =
            gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-create-button").as_str());
                    ...
                    match receiver.await {
                        Ok(Ok(teams)) => {
                            for team in teams {
                                ...
                                let members_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-members-button").as_str());
                                members_btn.add_css_class("flat");
                                let share_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-share-vault-button").as_str());
                                share_btn.add_css_class("flat");
                                let delete_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-delete-button").as_str());
                                ...
                                members_btn.connect_clicked(move |_| {
                                    let members_window = gtk4::Window::builder()
                                        .title(heelonvault_core::tr!("manage-teams-members-window-title").as_str())
                                        .modal(true)
                                    ...
                                    let controls = gtk4::Box::builder()
                                        ...
                                        .spacing(8)
                                        .build();
                                    let user_picker = gtk4::DropDown::from_strings(&[heelonvault_core::tr!("manage-teams-member-picker-placeholder").as_str()]);
                                    user_picker.set_hexpand(true);
                                    let role_picker = gtk4::DropDown::from_strings(&[
                                        heelonvault_core::tr!("manage-teams-role-member").as_str(),
                                        heelonvault_core::tr!("manage-teams-role-leader").as_str(),
                                    ]);
                                    role_picker.set_selected(0);
                                    let add_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-add-member-button").as_str());
                                                ...
                                                match receiver.await {
                                                    Ok(Ok((members, users))) => {
                                                        ...
                                                        *picker_ids_for_recv.borrow_mut() = ids;
                                                        let labels: Vec<String> = std::iter::once(heelonvault_core::tr!("manage-teams-member-picker-placeholder").to_string())
                                                        ...
                                                        for member in members {
                                                            ...
                                                            let role_text = match member.role {
                                                                TeamMemberRole::Leader => heelonvault_core::tr!("manage-teams-role-leader").to_string(),
                                                                TeamMemberRole::Member => heelonvault_core::tr!("manage-teams-role-member").to_string(),
                                                            };
                                                            let role_label = gtk4::Label::new(Some(role_text.as_str()));
                                                            role_label.set_width_chars(10);
                                                            let remove_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-remove-member-button").as_str());
                                    ...
                                    add_btn.connect_clicked(move |_| {
                                        ...
                                        if selected == 0 {
                                            Self::show_error(&window_for_add, AppError::Validation(heelonvault_core::tr!("manage-teams-error-select-user").to_string()));
                                            return;
                                        }
                                        let index = (selected - 1) as usize;
                                        let ids = picker_ids_for_add.borrow();
                                        if index >= ids.len() {
                                            Self::show_error(&window_for_add, AppError::Validation(heelonvault_core::tr!("manage-teams-error-invalid-user").to_string()));
                                            return;
                                        }
                                ...
                                share_btn.connect_clicked(move |_| {
                                    ...
                                    if current_master.is_empty() {
                                        Self::show_warning(
                                            &window_for_share,
                                            heelonvault_core::tr!("manage-teams-warning-vault-locked-title").as_str(),
                                            heelonvault_core::tr!("manage-teams-warning-vault-locked-body").as_str(),
                                        );
                                        return;
                                    }

                                    let share_window = gtk4::Window::builder()
                                        .title(heelonvault_core::tr!("manage-teams-share-select-window-title").as_str())
                                        .modal(true)
                                    ...
                                    let vault_picker = gtk4::DropDown::from_strings(&[
                                        heelonvault_core::tr!("manage-teams-share-select-placeholder").as_str(),
                                    ]);
                                    ...
                                    let actions = gtk4::Box::builder()
                                        ...
                                        .build();
                                    let cancel_btn = gtk4::Button::with_label(heelonvault_core::tr!("common-cancel").as_str());
                                    let share_apply_btn = gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-share-select-apply").as_str());
                                                ...
                                                Ok(Ok(vaults)) => {
                                                    if vaults.is_empty() {
                                                        ...
                                                        status_for_list.set_text(
                                                            heelonvault_core::tr!("manage-teams-share-select-empty").as_str(),
                                                        );
                                                        return;
                                                    }
                                                    ...
                                                    let labels: Vec<String> = std::iter::once(
                                                        heelonvault_core::tr!("manage-teams-share-select-placeholder").to_string(),
                                                    )
                                                    ...
                                                    *picker_ids_for_list.borrow_mut() = ids;
                                                    ...
                                                    status_for_list.set_text(
                                                        heelonvault_core::i18n::tr_args(
                                                            ...
                                                            &[("team", heelonvault_core::i18n::I18nArg::Str(team_name_for_list.as_str()))],
                                                        )
                                                        .as_str(),
                                                    );
                                                }
                                    ...
                                    share_apply_btn.connect_clicked(move |_| {
                                        ...
                                        if selected == 0 {
                                            Self::show_error(
                                                &window_for_result,
                                                AppError::Validation(
                                                    heelonvault_core::tr!("manage-teams-error-select-vault").to_string(),
                                                ),
                                            );
                                            return;
                                        }
                                            ...
                                            match receiver.await {
                                                Ok(Ok(())) => {
                                                    ...
                                                    Self::show_warning(
                                                        ...
                                                        heelonvault_core::tr!("manage-teams-warning-share-title").as_str(),
                                                        heelonvault_core::tr!("manage-teams-warning-share-body").as_str(),
                                                    );
                                                }
                                ...
                                delete_btn.connect_clicked(move |_| {
                                    let confirm = adw::MessageDialog::new(
                                        ...
                                        Some(heelonvault_core::tr!("manage-teams-delete-confirm-title").as_str()),
                                        Some(heelonvault_core::tr!("manage-teams-delete-confirm-body").as_str()),
                                    );
                                    confirm.add_response("cancel", heelonvault_core::tr!("common-cancel").as_str());
                                    confirm.add_response("delete", heelonvault_core::tr!("manage-teams-delete-button").as_str());
...

        {
            ...
            create_btn.connect_clicked(move |_| {
                let create_window = gtk4::Window::builder()
                    .title(heelonvault_core::tr!("manage-teams-create-window-title").as_str())
                    .modal(true)
                ...
                name_entry.set_placeholder_text(Some(
                    heelonvault_core::tr!("manage-teams-name-placeholder").as_str(),
                ));
                let actions = gtk4::Box::builder()
                    .orientation(gtk4::Orientation::Horizontal)
                    .spacing(8)
                    ...
                    .build();
                let cancel =
                    gtk4::Button::with_label(heelonvault_core::tr!("common-cancel").as_str());
                let create =
                    gtk4::Button::with_label(heelonvault_core::tr!("manage-teams-create").as_str());
        ...
        let title = match err {
            AppError::FeatureNotAvailable(feature) => {
                ...
                let dialog = adw::MessageDialog::new(
                    Some(window),
                    Some(heelonvault_core::tr!("feature-not-available-title").as_str()),
                    Some(body.as_str()),
                );
            ...
            AppError::Authorization(_) => {
                heelonvault_core::tr!("manage-teams-error-authorization").to_string()
            }
            _ => heelonvault_core::tr!("manage-teams-error-generic").to_string(),
        };
