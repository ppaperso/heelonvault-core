...
impl PasswordStrengthBar {
    ...
    // Phase 5a: not yet wired to login/edit dialogs. Owner: ppaadmin | Due: Phase 5b
    #[allow(dead_code)]
    ...
    // Phase 5a: not yet wired. Owner: ppaadmin | Due: Phase 5b
    #[allow(dead_code)]
    pub fn as_action_row(&self) -> adw::ActionRow {
