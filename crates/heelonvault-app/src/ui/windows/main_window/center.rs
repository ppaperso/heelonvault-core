...
pub(super) fn build_center_panel() -> CenterPanelWidgets {
    ...
    let filtered_status_page = adw::StatusPage::builder()
        .title(heelonvault_core::tr!("main-filtered-empty-title").as_str())
        .description(heelonvault_core::tr!("main-filtered-empty-description").as_str())
    ...
    let empty_title = gtk4::Label::new(Some(heelonvault_core::tr!("main-empty-title").as_str()));
    empty_title.add_css_class("title-3");
    empty_title.add_css_class("main-empty-title");

    let empty_description = gtk4::Label::new(Some(
        heelonvault_core::tr!("main-empty-description").as_str(),
    ));
    ...
    entries_stack.add_titled(
        &list_page,
        Some("list"),
        heelonvault_core::tr!("main-stack-grid").as_str(),
    );
    entries_stack.add_titled(
        &empty_state,
        Some("empty"),
        heelonvault_core::tr!("main-stack-empty").as_str(),
    );
    ...
    main_stack.add_titled(
        &entries_stack,
        Some("entries_view"),
        heelonvault_core::tr!("main-stack-secrets").as_str(),
    );
