...
pub(super) fn build_content_shell(
    ...
    let multivault_toggle = gtk4::ToggleButton::builder()
        .label(heelonvault_core::tr!("main-search-multivault-label").as_str())
        .tooltip_text(heelonvault_core::tr!("main-search-multivault-tooltip").as_str())
    ...
    let search_entry = gtk4::SearchEntry::builder()
        .placeholder_text(heelonvault_core::tr!("main-search-placeholder").as_str())
        .hexpand(true)
        .build();
    ...
    let help_title_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-title").as_str())
    ...
    let no_prefix_title_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-no-prefix-title").as_str())
        .halign(gtk4::Align::Start)
        .build();
    no_prefix_title_lbl.add_css_class("caption-heading");
    let no_prefix_body_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-no-prefix-body").as_str())
        .halign(gtk4::Align::Start)
        .wrap(true)
        .build();
    ...
    let prefix_title_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-prefix-title").as_str())
        .halign(gtk4::Align::Start)
        .build();
    prefix_title_lbl.add_css_class("caption-heading");
    let fields_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-fields").as_str())
        .halign(gtk4::Align::Start)
        .wrap(true)
        .build();
    ...
    let examples_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-examples").as_str())
        .halign(gtk4::Align::Start)
        .wrap(true)
        .margin_top(2)
        .build();
    ...
    let fuzzy_lbl = gtk4::Label::builder()
        .label(heelonvault_core::tr!("main-search-help-fuzzy").as_str())
        .halign(gtk4::Align::Start)
        .wrap(true)
        .build();
    ...
    let help_button = gtk4::MenuButton::builder()
        ...
        .tooltip_text(heelonvault_core::tr!("main-search-help-tooltip").as_str())
    ...
    let refresh_i18n: Rc<dyn Fn()> = {
        ...
        Rc::new(move || {
            multivault_toggle_r
                .set_label(heelonvault_core::tr!("main-search-multivault-label").as_str());
            multivault_toggle_r.set_tooltip_text(Some(
                heelonvault_core::tr!("main-search-multivault-tooltip").as_str(),
            ));
            search_entry_r.set_placeholder_text(Some(
                heelonvault_core::tr!("main-search-placeholder").as_str(),
            ));
            help_button_r.set_tooltip_text(Some(
                heelonvault_core::tr!("main-search-help-tooltip").as_str(),
            ));
            help_title_lbl_r.set_text(heelonvault_core::tr!("main-search-help-title").as_str());
            no_prefix_title_lbl_r
                .set_text(heelonvault_core::tr!("main-search-help-no-prefix-title").as_str());
            no_prefix_body_lbl_r
                .set_text(heelonvault_core::tr!("main-search-help-no-prefix-body").as_str());
            prefix_title_lbl_r
                .set_text(heelonvault_core::tr!("main-search-help-prefix-title").as_str());
            fields_lbl_r.set_text(heelonvault_core::tr!("main-search-help-fields").as_str());
            examples_lbl_r.set_text(heelonvault_core::tr!("main-search-help-examples").as_str());
            fuzzy_lbl_r.set_text(heelonvault_core::tr!("main-search-help-fuzzy").as_str());
        })
    };
