...
use heelonvault_core::models::{
    AuditAction, Team, TeamMember, TeamMemberRole, User, VaultShareRole,
};
use heelonvault_core::repositories::team_repository::TeamRepository;
use heelonvault_core::repositories::user_repository::UserRepository;
use heelonvault_core::repositories::vault_repository::VaultRepository;
...
use heelonvault_core::services::team_service::{KeyRotationResult, KeyShare, TeamService};
    ...
    TAuditSvc: AuditLogService + Send + Sync,
{
    ...
    fn serialize_vault_key_envelope(
        payload: &heelonvault_core::services::crypto_service::EncryptedPayload,
    ) -> SecretBox<Vec<u8>> {
        use heelonvault_core::services::crypto_service::NONCE_LEN;
    ...
    TAuditSvc: AuditLogService + Send + Sync,
{
    ...
    async fn list_visible_teams(&self, requester_id: Uuid) -> Result<Vec<Team>, AppError> {
        ...
        if matches!(requester.role, heelonvault_core::models::UserRole::Admin) {
...
mod tests {
    ...
    use heelonvault_core::repositories::team_repository::TeamRepository;
    use heelonvault_core::repositories::user_repository::UserRepository;
    use heelonvault_core::repositories::vault_repository::{
        VaultKeyShareEnvelope, VaultRepository,
    };
    use heelonvault_core::services::audit_log_service::AuditLogService;
    ...
    impl AuditLogService for StubAuditRepo {
        ...
        async fn list_recent(
            ...
            _: Uuid,
            _: u32,
        ) -> Result<Vec<heelonvault_core::models::AuditLogEntry>, AppError> {
            Ok(vec![])
        }
